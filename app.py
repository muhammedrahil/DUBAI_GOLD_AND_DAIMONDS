...
def ViewEmployee():
    if(session['lid'] == 'manager' or session['lid'] == 'director'):
        ...
        no=1
        arr=[list(i) for i in res]
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/viewEmployee.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch():
    if(session['lid'] == 'manager' or session['lid'] == 'director'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/SearchViewEmployee.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def ViewReaqusetEmployee():
    if(session['lid'] == 'manager' or session['lid'] == 'director'):
        ...
        return render_template("admin/viewLeaveRequest.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch_Leave():
    if(session['lid'] == 'manager' or session['lid'] == 'director'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/Search_branch_Leave.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch_Leave_accepted():
    if(session['lid'] == 'manager' or session['lid'] == 'director'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1        
        return render_template("admin/accept_list.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def SetEmployeestarget():
    if(session['lid'] == 'manager' or session['lid'] == 'director' or session['lid'] == 'accounts' ):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/setTarget.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch_SetTarget():
    if(session['lid'] == 'manager' or session['lid'] == 'director' or session['lid'] == 'accounts'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/Search_branch_SetTarget.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def viewupdatetargetEmployees():
    if(session['lid'] == 'manager' or session['lid'] == 'director'or session['lid'] == 'accounts'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/ViewtargetEmp.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_viewupdatetargetEmployees():
    if(session['lid'] == 'manager' or session['lid'] == 'director'or session['lid'] == 'accounts'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("admin/Search_viewupdatetargetEmployees.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def BranchEmployeePymentPage():
    if(session['lid'] == 'director'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("maneger/viewPymentEmployee.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch_Pyment():
    if(session['lid'] == 'director'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("maneger/Search_branch_Pyment.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def accept_list():
    ...
    for i in range(len(arr)):
            arr[i].append(no)
            no=no+1
    return render_template("maneger/accept_list.html", val=arr)
...
def accept_list_leave_coo():
    if(session['lid'] == 'coo'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("coo/accept_list.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def Search_branch_Leave_coo():
    if(session['lid'] == 'coo'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("coo/Search_branch_Leave.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def viewLeaveRequestPage():
    if(session['lid'] == 'employees'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("employee/viewLeaveRequestPage.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
...
def listPymentListseployee():
    if(session['lid'] == 'employees'):
        ...
        for i in range(len(arr)):
                arr[i].append(no)
                no=no+1
        return render_template("employee/listPymentListseployee.html", val=arr)
    else:
        return '''<script>alert("Unavailable");window.history.back()</script>'''
